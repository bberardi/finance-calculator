...
| #    | Work item                                              | Rationale / acceptance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---- | ------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 19.2 | **Optional passphrase encryption at rest & on export** | The product leads with "your numbers never leave your device," yet the on-device copy (`localStorage`, a single key) and the JSON export are **plaintext** — readable by anyone with access to the browser profile or the exported file, the real exposure on a shared or family computer. Offer an opt-in passphrase that encrypts the export (and optionally `localStorage`) entirely client-side via Web Crypto (AES-GCM + PBKDF2) — no backend, no key escrow, a clear "a forgotten passphrase is unrecoverable" warning. Hardens the founding privacy promise; pairs with the 18.4 backup reminder and 18.5 selective import. |

**Power-user UX (extends Phase 13)**

| #    | Work item                    | Rationale / acceptance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ---- | ---------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 19.3 | **Named on-device profiles** | Only one dataset persists (a single `localStorage` key), so modeling a second household, or a "current" vs. "planned life" world, forces manual export/import juggling. Named, switchable profiles kept on-device let a user hold several complete pictures at once and flip between them, reusing the existing serialization and the D8 validation/migration boundary. Client-side, on-device, not a budgeting feature; distinct from the 11.1 shareable link (a snapshot to hand off) and the 18.3 snapshots (points on one timeline). |
