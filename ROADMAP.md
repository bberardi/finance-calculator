...
| #    | Work item                                      | Rationale / acceptance                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ---- | ---------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 19.1 | **Import ↔ form validation parity charter**    | The JSON-import boundary (`data-helpers.ts`, e.g. `n >= 0`) and the edit-form validators (`validation-helpers.ts`, e.g. `Principal > 0`) enforce **different** rules in both directions: a file can import a position the form then refuses to save (paid-off 0-principal loan #194, negative-return investment #184), and the form accepts values (+Infinity #183) the import rejects. Six-plus open issues (#194, #184, #183, #178, #175) are instances of this one divergence, patched case-by-case yet recurring. Make one shared validation module the single source both boundaries call, guarded by a round-trip property test — anything the form can save must import and vice-versa — so the class can't reappear. This is the input-side counterpart to §4's "proof, not review confidence." |
